...
namespace MSC_WPF_BETA {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usersRow AddusersRow(string USERID, string FULLNAME, string PASSWORD) {
...
namespace MSC_WPF_BETA.Database1DataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[users] WHERE (([USERID] = @Original_USERID) AND ([FULLNAME] = " +
                "@Original_FULLNAME) AND ([PASSWORD] = @Original_PASSWORD))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([USERID], [FULLNAME], [PASSWORD]) VALUES (@USERID, @FU" +
                "LLNAME, @PASSWORD);\r\nSELECT USERID, FULLNAME, PASSWORD FROM users WHERE (USERID " +
                "= @USERID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [USERID] = @USERID, [FULLNAME] = @FULLNAME, [PASSWORD] = @PASSWORD WHERE (([USERID] = @Original_USERID) AND ([FULLNAME] = @Original_FULLNAME) AND ([PASSWORD] = @Original_PASSWORD));
SELECT USERID, FULLNAME, PASSWORD FROM users WHERE (USERID = @USERID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MSC_WPF_BETA.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT USERID, FULLNAME, PASSWORD FROM dbo.users";
        ...
        public virtual int Delete(string Original_USERID, string Original_FULLNAME, string Original_PASSWORD) {
        ...
        public virtual int Insert(string USERID, string FULLNAME, string PASSWORD) {
            if ((USERID == null)) {
        ...
        public virtual int Update(string USERID, string FULLNAME, string PASSWORD, string Original_USERID, string Original_FULLNAME, string Original_PASSWORD) {
            if ((USERID == null)) {
                throw new global::System.ArgumentNullException("USERID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FULLNAME, string PASSWORD, string Original_USERID, string Original_FULLNAME, string Original_PASSWORD) {
            return this.Update(Original_USERID, FULLNAME, PASSWORD, Original_USERID, Original_FULLNAME, Original_PASSWORD);
        }
    }
